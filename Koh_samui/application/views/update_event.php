...
<html lang="en">
    ...
    <body>
        ...
        <div class="containner">
            ...
            <br>
            <form action="<?php echo base_url(); ?>index.php/admin/update_event/<?php echo $this->uri->segment(3); ?>" method="POST">   
                <div class="content_place" id="tabs">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td><input type="text"class="inputs tBody" placeholder="Date" name="date" required="" value="<?php echo date("d M Y", strtotime($get_event->date)); ?>"/></td>
                        </tr>
